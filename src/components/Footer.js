...
<div className="container-fluid">
    ...
    <div className="socialMedia footter1">
	  ...
	  <p className="lowerSocial"><img src={LogoFacebook} className="img-fluid faceBook" alt="" /><img src={LogoTwitter} className="img-fluid twiTTer"alt="" /><img src={LogoInstagram} className="img-fluid instaGram" alt="" /></p>
	  <p className="upP">Euphorya is an independent online retailer offering variety of products ranging from branded products, stock from other retailers to its own label ‘T5S’.</p>
    </div>
